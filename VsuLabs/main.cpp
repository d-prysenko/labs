...
// 3. Ќапишите программу, котора€ выводит все перестановки длины N такие,
// что любые два соседних элемента отличаютс€ как минимум на два.
// Ќапример, если N = 4, то это 1324 и 2413.

void print_description()
{
	printf("3. Ќапишите программу, котора€ выводит все перестановки длины N такие,\n");
	printf("что любые два соседних элемента отличаютс€ как минимум на два.\n");
	printf("Ќапример, если N = 4, то это 1324 и 2413.\n\n");
}
...
int main()
{
	...
	printf("¬ведите длину последовательности: ");
	std::cin >> length;
